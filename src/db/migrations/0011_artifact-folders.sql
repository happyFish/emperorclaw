...
ALTER TABLE "artifacts" ADD COLUMN "path" text;--> statement-breakpoint
ALTER TABLE "artifacts" ADD COLUMN "preview_text" text;--> statement-breakpoint
...
ALTER TABLE "artifact_folders" ADD CONSTRAINT "artifact_folders_customer_id_customers_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "artifact_folders" ADD CONSTRAINT "artifact_folders_agent_id_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."agents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "artifact_folders" ADD CONSTRAINT "artifact_folders_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "artifact_folders" ADD CONSTRAINT "artifact_folders_parent_folder_id_fkey" FOREIGN KEY ("parent_folder_id") REFERENCES "public"."artifact_folders"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
