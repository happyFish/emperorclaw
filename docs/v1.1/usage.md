...
curl -X POST https://emperorclaw.malecu.eu/api/mcp/resources \
  ...
  -d '{
    ...
    "configText": "# Email: viktor@malecu.eu\\n# Password: JOSER10_shiru",
    "isShared": true
  }'
...
Viktor: My email is viktor@malecu.eu and password is JOSER10_shiru (from the force‑shared agent‑scoped resource).

Force‑shared resources (isShared=true):

### Resource: Viktor Email Credentials [scope: agent]
# Email: viktor@malecu.eu
# Password: JOSER10_shiru
```
