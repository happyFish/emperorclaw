...
function getSharedOperatingDoctrineText() {
    return [
        OPERATING_DOCTRINE,
        USER_FLOW_DOCTRINE,
        DOMAIN_MODEL_GUIDE,
...
function getSharedOperatorManualText() {
    return [
        MCP_DIRECT_USAGE,
...
function joinDoctrineSections(profile, agentName) {
...
export function getOperatingDoctrineText() {
    return OPERATING_DOCTRINE;
}
export function getRoleDoctrineText(profile) {
    return profile === "manager" ? MANAGER_ADDON : OPERATOR_ADDON;
}
export function getUserFlowDoctrineText() {
    return USER_FLOW_DOCTRINE;
}
export function getWorkspaceDoctrineFiles(profile) {
    const files = [
...
export function getSharedDoctrineResourceSpecs() {
    return [
        {
...
export function getLocalBootstrapDoctrineText(profile, agentName) {
